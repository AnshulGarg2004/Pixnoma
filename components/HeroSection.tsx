            ...
            <div className='text-center z-10 px-6'>
                <div className={`transition-all duration-1000 ${textVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <h1 className='text-6xl md:text-9xl font-black mb-6 tracking-tight'>
                        <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text tracking-tight text-transparent animate-pulse">Create</span>
                        <br />
                        <span className=' text-white'>Without Limits</span>
                    </h1>
                    <p className='text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed'>Professional image editing powered by AI. Crop, resize, adjust colors, remove backgrounds, and enhance your images with cutting-edge technology.</p>
                    <div className='flex flex-col sm:flex-row gap-6 justify-center items-center mb-12'>
                        ...
                        <Button variant={'glassy'} size={'xl'}>Watch Demo</Button>
